package com.casleuth.casleuthbackend.config;
...
public class SwaggerConfig {
    ...
    public Docket restApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("标准接口")
                .apiInfo(apiInfo("CASleuth软件接口", "1.0"))
                .useDefaultResponseMessages(true)
                .forCodeGeneration(false)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.casleuth.casleuthbackend.controller"))
